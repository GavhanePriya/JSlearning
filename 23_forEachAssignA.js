...
arrayNumber.forEach((currentValue , index , arrayNumber) => {
    console.log(currentValue,index,arrayNumber );
});
console.log(`---------------------------step2---------------------------`);
...
arrayNumber.forEach((currentValue) => {
    ...
    arrayNumber.forEach((currentValue,index) => {
        if (index %2== 0) {
            console.log(`the even index in array is :${index} is ${currentValue}`);
