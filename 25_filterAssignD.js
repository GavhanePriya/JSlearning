class Employee {
  ...
  for (const employee of arrayOfItandHRDept) {
    console.log(`The employee of departmnet is :${employee.emp_name}, employee name : ${employee.emp_dept}`);
  }
  ...
  const gretarThan50 = arrayEmps.filter((employee)=>{
    ...
    console.log(`There are  employees id are greater than 50 is : ${employee.emp_id}`);
  }
...
console.log(`${employee.emp_name}`);
  ...
  console.log(`The total of employee salary is : ${salarySum/arrayEmps.length}`);
  console.log(`---------------------------------------step 6-----------------------`);
